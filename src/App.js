...
function App() {
  ...
  return (
    <div className="App">
      <div  style={{ maxHeight: `${window.innerHeight+"px"}` }} id="first" className="first">
      <Form message={message} inputHandler={inputHandler} submitHandler={submitHandler} />
      <MessageField messageList={messageList}/>
      </div>
    <div id="second" className="second" style={{ height: `${window.innerHeight+"px"}` }}>
     <Time/>
     </div>
    </div>
  );
